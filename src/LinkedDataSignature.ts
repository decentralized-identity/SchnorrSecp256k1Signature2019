...
export default class LinkedDataSignature {
  public type: any;
  public creator: any;
  public verificationMethod: any;
  public proof: any;
  public date: any;
  public useNativeCanonize: any;
  /**
  ...
  async verifyProof({
    ...
    try {
      ...
      const verified: any = await this.verifySignature({
        verifyData,
        verificationMethod,
        document,
        proof,
   ...
   */
  async sign(args: any) {
    throw new Error('Must be implemented by a derived class.' + args);
  }
